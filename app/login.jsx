  ...
  const loginMain = async () => {
    ...
    try {
      const response = await fetch(
        "https://yourbeirut.tech:3002/api/auth/loginUser",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        //save username to async storage
        await AsyncStorage.setItem("username", username.toString());
        //get chat tag
        // /api/chat/getUserChat - get chat tag
        const response = await fetch(
          "https://yourbeirut.tech:3002/api/chat/getUserChat?username=" +
            username,
          {
            method: "GET",
            headers: {
        ...
        const chatTag = data[0].chatTag;
        await AsyncStorage.setItem("chatTag", chatTag.toString());
