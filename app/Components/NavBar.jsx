    ...
    >
      ...
      <View style={styles.section}>
        ...
        >
          <FontAwesome
            name="cutlery"
            size={18}
            color={selectedRestaurant === "Italian" ? "red" : "white"}
          />
          <Text
            style={[
              styles.sectionText,
        ...
        >
          <FontAwesome
            name="cutlery"
            size={18}
            color={selectedRestaurant === "American" ? "red" : "white"}
          />
          <Text
            style={[
              styles.sectionText,
        ...
        >
          <FontAwesome
            name="cutlery"
            size={18}
            color={selectedRestaurant === "Sweet" ? "red" : "white"}
          />
          <Text
            style={[
              styles.sectionText,
      ...
      <View style={styles.section}>
        ...
        >
          ...
          <Text style={styles.sectionText}>View Gallery</Text>
        </TouchableOpacity>
      </View>
